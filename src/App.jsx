...
const PRODUCTS = [
  ...
  /* Mix (vanaf 50) – zelfde pricing als 50+ normaal */
  {
    ...
    tags: ["normaal", "85x55mm", "vinyl"],
    variants: [
      { id: "50", label: "50 stuks", price: 9.95 },
      { id: "100", label: "100 stuks", price: 15.95 },
      { id: "150", label: "150 stuks", price: 19.5 },
  ...
  /* ---------------- Accessoires (aparte sectie) ---------------- */
  {
    ...
    saleBadge: "-50%",
    variants: [
      { id: "1", label: "1 rol", price: 4.99 },
      { id: "2", label: "2 rollen", price: 9.99 },
      { id: "3", label: "3 rollen", price: 14.99 },
      { id: "5", label: "5 rollen", price: 24.99 },
    ],
...
{ id: "XL", label: "Maat XL (op bestelling)", price: 19.99 },
...
{ id: "XXL", label: "Maat XXL", price: 19.99 },
    ...
    extra: "1905 T-Shirt · Verkrijgbaar in S t/m XL ·.",
    group: "kleding",
  },
       {
    id: "t-shirt-mentalita",
    title: "Mentalita Den Haag T-Shirt",
    img: "/img/mentalita-tshirt.jpg",
    tags: ["t-shirt", "accessoires", "denhaag", "mentalita"],
    oldPrice: 23.99,
    saleBadge: "-17%",
    variants: [
{ id: "S", label: "Maat S", price: 19.99 },
...
{ id: "XXL", label: "Maat XXL", price: 19.99 },
    ...
    extra: "mentalita T-Shirt · Verkrijgbaar in S t/m XL ·.",
    group: "kleding",
  },
  {
  ...
  },
{
  ...
  },
  {
    ...
    variants: [
      ...
      { id: "5", label: "5 stuks", price: 18.950 },
    ],
  ...
  <p className="text-xs text-neutral-500 mt-1">
    {
      p.group === "kleding"
        ...
        ? "4 Verschillende designs · Contour gesneden"
...
<p className="mt-2 text-sm text-neutral-700">
  ...
  📦 Vanaf 101 normale stickers of XXL, A4, 1 meter, kleding en accessoires:
  <strong> €5,95</strong>
</p>
          </div>
          <div className="rounded-3xl border p-6 shadow-sm">
